...
class Tx_GenesezBlogExample_Domain_Model_Post extends Tx_Extbase_DomainObject_AbstractEntity {
	 ...
	 * Setter for blog
	 *
	 * @param Tx_GenesezBlogExample_Domain_Model_Blog $blog 
	 * @return void
	 */
	public function setBlog(Tx_GenesezBlogExample_Domain_Model_Blog $blog) {
		$this->blog = $blog;
	}
	/**
	 * Getter for author
	 *
	 * @return Tx_GenesezBlogExample_Domain_Model_Person 
	 */
	 ...
	 * Setter for author
	 *
	 * @param Tx_GenesezBlogExample_Domain_Model_Person $author 
	 * @return void
	 */
	public function setAuthor(Tx_GenesezBlogExample_Domain_Model_Person $author) {
		$this->author = $author;
	}
	/**
	 * Getter for tags
	 ...
	 * InsertIn for tags
	 *
	 * @param Tx_GenesezBlogExample_Domain_Model_Tag $toAdd 
	 * @return void
	 */
	public function addTags(Tx_GenesezBlogExample_Domain_Model_Tag $toAdd) {
		$this->tags->attach($toAdd);
	}
	/**
	 * RemoveFrom for tags
	 *
	 * @param Tx_GenesezBlogExample_Domain_Model_Tag $toRemove 
	 * @return void
	 */
	public function removeTags(Tx_GenesezBlogExample_Domain_Model_Tag $toRemove) {
	 ...
	 *
	 * @param Tx_GenesezBlogExample_Domain_Model_Comment $toAdd 
	 * @return void
	 */
	public function addComments(Tx_GenesezBlogExample_Domain_Model_Comment $toAdd) {
		$this->comments->attach($toAdd);
	}
	/**
	 * RemoveFrom for comments
	 *
	 * @param Tx_GenesezBlogExample_Domain_Model_Comment $toRemove 
	 * @return void
	 */
	public function removeComments(Tx_GenesezBlogExample_Domain_Model_Comment $toRemove) {
	 ...
	 *
	 * @param Tx_GenesezBlogExample_Domain_Model_Post $toAdd 
	 * @return void
	 */
	public function addRelatedPosts(Tx_GenesezBlogExample_Domain_Model_Post $toAdd) {
		$this->relatedPosts->attach($toAdd);
	}
	/**
	 * RemoveFrom for relatedPosts
	 *
	 * @param Tx_GenesezBlogExample_Domain_Model_Post $toRemove 
	 * @return void
	 */
	public function removeRelatedPosts(Tx_GenesezBlogExample_Domain_Model_Post $toRemove) {
