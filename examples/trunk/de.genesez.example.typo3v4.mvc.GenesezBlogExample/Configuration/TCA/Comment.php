...
$TCA['tx_gzblogexample_domain_model_comment'] = array (
	'ctrl' => $TCA['tx_gzblogexample_domain_model_comment']['ctrl'],
	'interface' => array(
	...
	'columns' => array(
		...
		'date' => array(
			'exclude' => true,
			'label' => 'LLL:EXT:gz_blog_example/Resources/Private/Language/locallang_db.xml:tx_gzblogexample_domain_model_comment.date',
		...
		'author' => array(
			'exclude' => false,
			'label' => 'LLL:EXT:gz_blog_example/Resources/Private/Language/locallang_db.xml:tx_gzblogexample_domain_model_comment.author',
		...
		'email' => array(
			'exclude' => false,
			'label' => 'LLL:EXT:gz_blog_example/Resources/Private/Language/locallang_db.xml:tx_gzblogexample_domain_model_comment.email',
		...
		'content' => array(
			'exclude' => true,
			'label' => 'LLL:EXT:gz_blog_example/Resources/Private/Language/locallang_db.xml:tx_gzblogexample_domain_model_comment.content',
