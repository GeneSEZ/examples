...
$TCA['tx_gszrealestate_domain_model_heatingtype'] = array (
	'ctrl' => $TCA['tx_gszrealestate_domain_model_heatingtype']['ctrl'],
	'interface' => array(
	...
	'columns' => array(
		...
		'l10n_parent' => array(
			...
			'config' => array(
				...
				'foreign_table_where' => 'AND tx_gszrealestate_domain_model_heatingtype.uid=###REC_FIELD_l10n_parent### AND tx_gszrealestate_domain_model_heatingtype.sys_language_uid IN (-1,0)',
			),
		),
		...
		'specification' => array(
			'exclude' => false,
			'label' => 'LLL:EXT:gsz_real_estate/Resources/Private/Language/locallang_db.xml:tx_gszrealestate_domain_model_heatingtype.specification',
