...
class Tx_GenesezBlogExample_Controller_BlogController extends Tx_GenesezBlogExample_Controller_AbstractController {
	 ...
	 *
	 * @param Tx_GenesezBlogExample_Domain_Model_Blog $newBlog A fresh blog object taken as a basis for the rendering
	 * @return void
	 ...
	 * Creates a new blog
	 *
	 * @param Tx_GenesezBlogExample_Domain_Model_Blog $newBlog A fresh Blog object which has not yet been added to the repository
	 * @return void
	 */
	 ...
	 *
	 * @param Tx_GenesezBlogExample_Domain_Model_Blog $blog The blog to be edited. This might also be a clone of the original blog already containing modifications if the edit form has been submitted, contained errors and therefore ended up in this action again.
	 * @return void
	 * @dontvalidate $blog
	 */
	 ...
	 *
	 * @param Tx_GenesezBlogExample_Domain_Model_Blog $blog A not yet persisted clone of the original blog containing the modifications
	 * @return void
	 */
	 ...
	 *
	 * @param Tx_GenesezBlogExample_Domain_Model_Blog $blog The blog to delete
	 * @return void
	 */
	 ...
	 *
	 * @return Tx_GenesezBlogExample_Domain_Repository_BlogRepository 
	 */
	 ...
	 *
	 * @param Tx_GenesezBlogExample_Domain_Repository_BlogRepository $blogRepository 
	 * @return void
	 */
	public function injectBlogRepository(Tx_GenesezBlogExample_Domain_Repository_BlogRepository $blogRepository) {
		$this->blogRepository = $blogRepository;
	}
	/**
	 * Getter for administratorRepository
	 *
	 * @return Tx_GenesezBlogExample_Domain_Repository_AdministratorRepository 
	 */
	 ...
	 *
	 * @param Tx_GenesezBlogExample_Domain_Repository_AdministratorRepository $administratorRepository 
	 * @return void
	 */
	public function injectAdministratorRepository(Tx_GenesezBlogExample_Domain_Repository_AdministratorRepository $administratorRepository) {
