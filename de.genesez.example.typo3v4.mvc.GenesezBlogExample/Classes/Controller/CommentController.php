...
class Tx_GenesezBlogExample_Controller_CommentController extends Tx_GenesezBlogExample_Controller_AbstractController {
	 ...
	 *
	 * @param Tx_GenesezBlogExample_Domain_Model_Post $post The post the comment is related to
	 * @param Tx_GenesezBlogExample_Domain_Model_Comment $newComment The comment to create
	 * @return void
	 */
	 ...
	 *
	 * @param Tx_GenesezBlogExample_Domain_Model_Post $post The post the comment is related to
	 * @param Tx_GenesezBlogExample_Domain_Model_Comment $comment The comment to be deleted
	 * @return void
	 */
